...
module WinduZeitwerkConfig
  ...
  # The loader object for Windu
  def self.loader
    @loader
  end

  # Configure the Zeitwerk loader, See https://github.com/fxn/zeitwerk
  # This all has to happen before the first 'module Windu' declaration
  def self.setup_zeitwerk_loader(zloader)
    ...
    #####################################
    # loader.on_load('Windu::SomeClass') do |klass, abspath|
    #   load_msg "I just loaded #{klass} from #{abspath}"
    # end

    # callback for when anything loads
    #  - const_path is like "Windu::SomeClass" or "Windu::SomeClass::SOME_CONST_ARRY"
    #  - value is the value that constant contains after loading,
    #    e.g. the class Windu::SomeClass for 'Windu::SomeClass' or
    #    an Array for the constant  "Windu::SomeClass::SOME_CONST_ARRY"
