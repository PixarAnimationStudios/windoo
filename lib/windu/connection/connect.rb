...
module Windu
  ...
  class Connection
    ...
    module Connect
      ...
      # either:
      #
      # A Windu::Connection::Token object, which can be extracted from an active
      # Windu::Connection via its #token method
      #
      # or
      #
      ...
      def validate_connected
        using_dft = 'Windu.cnx' if self == Windu.cnx
        unless connected?
      ...
      def parse_token(params)
        ...
        @token = Windu::Connection::Token.new(
