  ...
  module API
    ...
    module BaseClasses
      ...
      class JSONObject
        ...
        # Windu::API::Mixins::Immutable, which overrides
        # this method
        def self.mutable?
          true
        end
        ...
        def self.json_attributes
          return {} if self == Windu::API::BaseClasses::JSONObject
        ...
        def self.parse_json_attributes
          ...
          self::JSON_ATTRIBUTES.each do |attr_name, attr_def|
            if attribute_already_parsed?(attr_name)
              Windu.load_msg "Ancestor of #{self} has already parsed attribute #{attr_name}"
              next
            end
        ...
        def self.validate_attr(attr_name, value)
          ...
          Windu::Validate.json_attr value, attr_def: attr_def, attr_name: attr_name
