  ...
  module API
    ...
    class Connection
      ...
      class Token
        ...
        # @return [Time] when was this Windu::TitleServer::Connection::Token originally created?
        ...
        def init_from_pw
          ...
          if resp.success?
            ...
            raise Windu::AuthenticationError, 'Incorrect user name or password'
          else
            ...
            puts resp.body
            puts
            raise Windu::ConnectionError, "An error occurred while authenticating: #{resp.body}"
          end
        ensure
        ...
        def refresh
          ...
          if expired?
            ...
            raise Windu::InvalidTokenError, 'Token has expired'
          end
          ...
          raise Windu::InvalidTokenError, 'An error occurred while refreshing the token'
        end
        ...
        def parse_params(**params)
          ...
          @timeout = params[:timeout] || Windu::API::Connection::DFT_TIMEOUT
        ...
        def parse_token_status
          ...
          raise Windu::InvalidTokenError, 'Token is not valid' unless resp.success?
