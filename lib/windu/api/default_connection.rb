  ...
  module API
    ...
    module DefaultConnection
      ...
      def default_connection
        @@default_connection ||= Windu::API::Connection.new name: :default
      end
      ...
      def connect(url = nil, **params)
        params[:name] ||= :default
        @@default_connection = Windu::API::Connection.new url, **params
      ...
      #
      def cnx=(connection)
        unless connection.is_a? Windu::API::Connection
          raise 'Title Editor connections must be instances of Windu::API::Connection'
        end
