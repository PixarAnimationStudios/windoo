...
module Windu
  ...
  module API
    ...
    class Patch < Windu::API::BaseClasses::JSONObject
      ...
      JSON_ATTRIBUTES = {
        ...
        # @!attribute killApps
        # @return [Array<Windu::API::KillApp>] The apps that must be quit before
        #   installing this patch
        killApps: {
          class: Windu::API::KillApp,
          multi: true
        },

        # @!attribute components
        # @return [Array<Windu::API::Component>] The components of this patch.
        #   NOTE: there can be only one!
        components: {
          class: Windu::API::Component,
          multi: true
        },

        # @!attribute capabilities
        # @return [Array<Windu::API::Capability>] The criteria which identify
        #   computers capable of running, and thus installing, this patch.
        capabilities: {
          class: Windu::API::Capability,
          multi: true
        }
      ...
      def initialize(json_data)
        super
        @killApps = killApps.map { |data| Windu::API::KillApp.new data }
        @components = components.map { |data| Windu::API::Component.new data }
        @capabilities = capabilities.map { |data| Windu::API::Capability.new data }
      end
