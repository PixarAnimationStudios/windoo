...
module Windu
  ...
  # A class for working with pre-defined settings & preferences for Windu
  #
  ...
  # values throughout Windu. It can be accessed via Windu.config in applications.
  #
  # @note Many values in Windu will also have a hard-coded default, if not defined
  # in the configuration.
  #
  # When the Windu::Configuration instance is created, the {GLOBAL_CONF} file (/etc/windu.conf)
  # is examined if it exists, and the items in it are loaded into the attributes.
  #
  # Then the user-specific {USER_CONF} file (~/.windu.conf) is examined if it exists, and
  ...
  #   Windu.config.title_editor_server_name  # => 'foobar.appcatalog.jamfcloud.com'
  #
  #   # sets the title_editor_server_name to a new value
  #   Windu.config.title_editor_server_name = 'baz.appcatalog.jamfcloud.com'
  #
  #
  ...
  #   Windu.config.reload '/path/to/other/file'
